...
While my **"home page"** is szabgab.com I manage several domains. Some of them
are mine exclusively, such as this site. Others are community related such as the
web site of the [Israeli Perl Mongers](https://perl.org.il/) or
that of [Padre, the Perl IDE](https://padre.perlide.org/).
...
**My objective is** to use and improve these sites and other accounts to the benefit of the users
...
I have been reading the [Copyblogger](https://www.copyblogger.com/),
...
What happened is, that in most of 2009 and in the beginning of 2010 I was focusing a lot on
writing and promoting [Padre, the Perl IDE](https://padre.perlide.org/)
...
In mid 2011 the [contract was ended](/contract-is-finished-life-is-beautiful)
...
started the <a href="/perl-tutorial">Perl tutorial</a>, created the [Perl Weekly](https://perlweekly.com/),
and created 3 video courses already using the [Perl Maven](/perl-maven) name.
...
<!--
On <a href="http://www.linkedin.com/in/szabgab">LinkedIN</a> I have 937 contact.

On <a href="http://www.facebook.com/szab529gab">Facebook</a> I have 378 friends.
-->
...
I published two Perl-related <a href="/articles">articles</a> on <a href="http://i-programmer.info/">I-Programmer</a>.
...
used the <a href="/perl-maven">Perl Maven</a> name for the video courses.
...
On Facebook there is a total of 2 people who liked the
...
Write at least 20 <a href="/articles">articles</a> for other sites.
